...
Ο χρόνος (`39.69ms`) αφορά τοπική in-memory MongoDB με 9.349 έγγραφα και δεν αποτελεί benchmark παραγωγής. Το ουσιαστικό κέρδος είναι αρχιτεκτονικό: ο υπολογισμός γίνεται στη βάση, χωρίς μεταφορά όλων των εγγράφων στο Node.
